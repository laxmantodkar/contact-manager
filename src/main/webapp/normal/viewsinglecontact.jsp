...
<title>View single contact</title>
<link rel="stylesheet"
			...
			<div class="content">
				<div class="singleImage">
					<div>
						...
						<div style="color: blue; font-size: 30px; padding-top: 10px;">${contact.name}
							(${contact.secondName})</div>
					</div>
				</div>
				<hr style="border: 1px solid black; width: 100%;">
				<div class="singleId filed">
					<div>ID</div>
					<div>SCMUSER-${contact.cId}</div>
				</div>
